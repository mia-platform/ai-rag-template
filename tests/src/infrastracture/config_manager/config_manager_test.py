...
from src.infrastracture.config_manager.config_manager import ConfigManager, ConfigManagerParams, ModelValidationError, ConfigValidationError
...
def setup_config_manager(
    ...
    params = ConfigManagerParams(
        ...
        config_schema_path=str(schema_path),
        model=model,
        logger=logger
    )
